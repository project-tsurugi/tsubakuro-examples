...
final class OrderLineAccessor implements TableAccessor {
    ...
    private final String createTable = "CREATE TABLE ORDER_LINE (ol_o_id BIGINT NOT NULL, ol_d_id BIGINT NOT NULL, ol_w_id BIGINT NOT NULL, ol_number BIGINT NOT NULL, ol_i_id BIGINT NOT NULL, ol_supply_w_id BIGINT NOT NULL, ol_delivery_d CHAR(25), ol_quantity BIGINT NOT NULL, ol_amount DOUBLE NOT NULL, ol_dist_info CHAR(24) NOT NULL, PRIMARY KEY(ol_w_id, ol_d_id, ol_o_id, ol_number))";
