...
final class CustomerAccessor implements TableAccessor {
    ...
    private final String createTable = "CREATE TABLE CUSTOMER (c_id BIGINT NOT NULL, c_d_id BIGINT NOT NULL, c_w_id BIGINT NOT NULL, c_first VARCHAR(16) NOT NULL, c_middle CHAR(2) NOT NULL, c_last VARCHAR(16) NOT NULL, c_street_1 VARCHAR(20) NOT NULL, c_street_2 VARCHAR(20) NOT NULL, c_city VARCHAR(20) NOT NULL, c_state CHAR(2) NOT NULL, c_zip  CHAR(9) NOT NULL, c_phone CHAR(16) NOT NULL, c_since CHAR(25) NOT NULL, c_credit CHAR(2) NOT NULL, c_credit_lim DOUBLE NOT NULL, c_discount DOUBLE NOT NULL, c_balance DOUBLE NOT NULL, c_ytd_payment DOUBLE NOT NULL, c_payment_cnt BIGINT NOT NULL, c_delivery_cnt BIGINT NOT NULL, c_data VARCHAR(500) NOT NULL, PRIMARY KEY(c_w_id, c_d_id, c_id))";
    private final String createIndex = "CREATE INDEX CUSTOMER_SECONDARY ON CUSTOMER (c_w_id, c_d_id, c_last, c_first)";
